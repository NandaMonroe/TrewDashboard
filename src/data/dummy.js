...
export let topSellingAndGrossingItems = [
  {
    ...
    items: [
      {
        img: pl,
        text: "Thai Salad with Peanut Sauce and Ice Tea",
        money: "$ 2.302,00",
        percentage: "-0,5%",
      ...
      {
        img: pl1,
        text: "Sirloin Steak Well Done with BBQ Sauce",
        money: "$ 2.302,00",
        percentage: "+2,5%",
        color: "text-lime-500",
      },
      {
        img: pl2,
        text: "Chicken Crispy with Corn Sauce",
        money: "$ 2.302,00",
        percentage: "-0,5%",
        color: "text-purple-500",
      },
...
export let multilocation = [
  {
    ...
    cities: [
      ...
      {
        city: "Los Angeles",
        multilocation: ["Mid-Wilshire", "Venice"],
      },
      {
        city: "San Francisco",
        multilocation: ["San Jose", "San Diego"],
      },
      {
        city: "Denver",
        multilocation: ["Capitol Hill", "RiNo"],
      },
      {
        city: "Atlanta",
        multilocation: ["Little Five Points", "Atlantic Station", "Midtown"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        city: "Melbourne",
        multilocation: ["CBD", "Karingal"],
      },
      {
        city: "Brisbane",
        multilocation: ["South Bank"],
      },
      {
        city: "Adelaide",
        multilocation: ["Silver Sands", "East End"],
      },
    ],
  },
  {
    ...
    cities: [
      ...
      {
        city: "Montreal",
        multilocation: ["Old Montreal", "Downtown", "Quartier Latin"],
      },
      {
        city: "Vancouver",
        multilocation: ["Gastown", "Downtown"],
      },
    ],
  },
  {
