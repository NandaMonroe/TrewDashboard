...
import { dataBar } from '../../data/dummy'
import { dateOptions } from '../../data/dummy'
  ...
  return (
        <div className=' w-full'>
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-right text-purple-500 text-sm font-semibold leading-tight cursor-pointer">View All</div>
            </div>
                            ...
                            dateOptions.map(({ country, cities }, index) => {
                                return (
                                    <div key={index} onClick={() => {
                                        ...
                                        setCityArray(cities)
                                    }} className='p-2 px-3 text-zinc-900 hover:text-purple-500 duration-500 hover:bg-purple-50 text-lg hover:font-semibold'>
                                        {country}
                                    </div>
                                )
                            })
